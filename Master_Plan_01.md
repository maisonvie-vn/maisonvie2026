...
* **Quy trình vận hành nội bộ (POS, KDS Bếp & BDS Quầy Bar nâng cao):**
  ...
  * **Module Lộ trình Đào tạo & Thăng tiến Nhân sự theo cấp bậc (CRM Integrated Training & Promotion Paths - CẬP NHẬT CHI TIẾT):**
    ...
    * **Chặn phân ca dựa trên kỹ năng (Skill-based Shift Assignment) & Cơ chế giải quyết nút thắt (Manager Override Privilege):**
    ...
    * **Phòng chống đánh giá cảm tính & Thiên vị chấm điểm thực hành (Evidence-based Assessment - THÊM MỚI):**
      - Điểm thi thực hành thực tế do Manager ca trực chấm trực tiếp trên CRM chiếm 70% trọng số, dễ dẫn đến vị thế cá nhân.
  ...
  * **QUY TRÌNH NHẬP - XUẤT - TỒN CHI TIẾT TẠI QUẦY BAR (CẬP NHẬT CHI TIẾT):**
    ...
    * **Nhật ký khui rượu vang (Opened Bottles Log):** Tự động đếm ngược hạn sử dụng tối đa của chai rượu vang đã khui (72 giờ đối với vang thường, 14 ngày nếu dùng Coravin bảo quản khí Argon), phát cảnh báo đỏ để Sommelier ưu tiên upselling trước khi vang bị oxy hóa hỏng hoàn toàn.
...
* **Tự động hóa kho Bếp & Quản lý Hao hụt sơ chế (Yield Management):**
  ...
  * **Hàng đợi Decant rượu vang đỏ cao cấp (Sommelier Decanting Queue & Breathing Predictor - THÊM MỚI - ĐÃ DUYỆT):**
    ...
    - **Đếm ước thời gian thở:** Hệ thống tự động tính toán thời gian thở tối ưu khuyến nghị dựa trên giống nho và niên vụ (vintage). CRM tự động phát tín hiệu báo cho POS cầm tay của FOH khi rượu đạt đỉnh vị ngon nhất sau decanting để FOH sảnh đồng bộ phối hợp lên món ăn chính hoàn hảo.
