...
const I18N = {
  vi: {
    ...
    errorMsg: "Đã có lỗi xảy ra khi gửi yêu cầu. Vui lòng thử lại hoặc gọi Hotline: +84 904150383.",
  ...
  en: {
    ...
    errorMsg: "Failed to submit request. Please try again or call our hotline: +84 904150383.",
  ...
  fr: {
    ...
    errorMsg: "Impossible d'envoyer votre demande. Veuillez réessayer ou composer le +84 904150383.",
  ...
  ja: {
    ...
    errorTitle: "通信エラー",
    errorMsg: "リクエストの送信に失敗しました。もう一度お試しいただくか、お電話にてご連絡ください: +84 904150383。",
    courseTitle: "メニュー詳細",
  ...
  ko: {
    ...
    errorTitle: "연결 오류",
    errorMsg: "신청 전송에 실패했습니다. 다시 시도하시거나 핫라인으로 연락해 주십시오: +84 904150383.",
  ...
  hk: {
    ...
    errorTitle: "連接失敗",
    errorMsg: "提交申請時發生錯誤。請重試或撥打熱線：+84 904150383。",
    courseTitle: "套餐菜品詳情",
    allergenLabel: "避免過敏原",
