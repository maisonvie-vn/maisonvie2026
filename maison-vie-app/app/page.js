...
const I18N = {
  vi: {
    ...
    errMsg: "Không thể kết nối đến máy chủ. Vui lòng kiểm tra lại thông tin hoặc liên hệ hotline: +84 904150383.",
    footerHours: "Giờ Hoạt Động",
    footerContact: "Liên Hệ",
    footerAddress: "Địa chỉ: 28 Tăng Bạt Hổ, Phường Hai Bà Trưng, Hà Nội",
  ...
  en: {
    ...
    errMsg: "Failed to submit. Please check your network or call our hotline: +84 904150383.",
    footerHours: "Opening Hours",
    footerContact: "Contact Us",
    footerAddress: "28 Tang Bat Ho, Hai Ba Trung Ward, Hanoi",
  ...
  fr: {
    ...
    errMsg: "Impossible d'envoyer la demande. Veuillez réessayer ou nous contacter au +84 904150383.",
    footerHours: "Heures d'Ouverture",
    footerContact: "Contact",
    footerAddress: "28 Tang Bat Ho, Quartier de Hai Ba Trung, Hanoï",
  ...
  ja: {
    ...
    errTitle: "エラーが発生しました",
    errMsg: "送信できませんでした。通信環境を確認いただくか、お急ぎの場合はお電話（+84 904150383）にてご連絡ください。",
    footerHours: "営業時間",
    footerContact: "お問い合わせ",
    footerAddress: "ハノイ市ハイバーチュン坊タンバットホー28番地",
    allergenCelery: "セロリ",
    allergenGluten: "グルテン",
  ...
  ko: {
    ...
    errTitle: "오류가 발생했습니다",
    errMsg: "제출에 실패했습니다. 네트워크를 확인하시거나 고객센터(+84 904150383)로 직접 연락해 주십시오.",
    footerHours: "영업 시간",
    footerContact: "고객 센터",
    footerAddress: "하노이시 하이바쭝동 탄밧호 28",
    allergenCelery: "셀러리",
    allergenGluten: "글루텐",
  ...
  hk: {
    ...
    errTitle: "發生錯誤",
    errMsg: "無法提交申請。請檢查您的網絡，或直接致電熱線：+84 904150383 聯絡我們。",
    footerHours: "營業時間",
    footerContact: "聯絡我們",
