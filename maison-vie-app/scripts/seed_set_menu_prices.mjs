...
const PRICES_DATA = [
  { id: 'd0000001-e000-4000-b000-000000000001', name: { en: 'degustation_services_3', vi: 'Giá Degustation 3 món', fr: 'Prix Dégustation 3 services' }, price: 2400000 },
  { id: 'd0000001-e000-4000-b000-000000000002', name: { en: 'degustation_services_4', vi: 'Giá Degustation 4 món', fr: 'Prix Dégustation 4 services' }, price: 3000000 },
  { id: 'd0000001-e000-4000-b000-000000000003', name: { en: 'degustation_services_5', vi: 'Giá Degustation 5 món', fr: 'Prix Dégustation 5 services' }, price: 3600000 },
  { id: 'd0000001-e000-4000-b000-000000000004', name: { en: 'degustation_services_6', vi: 'Giá Degustation 6 món', fr: 'Prix Dégustation 6 services' }, price: 4200000 },
  { id: 'd0000001-e000-4000-b000-000000000005', name: { en: 'degustation_services_7', vi: 'Giá Degustation 7 món', fr: 'Prix Dégustation 7 services' }, price: 4800000 },
  ...
  { id: 'd0000001-e000-4000-b000-000000000011', name: { en: 'degustation_supp_wagyu', vi: 'Phụ thu bò Wagyu', fr: 'Supplément boeuf Wagyu' }, price: 650000 },
  
  { id: 'd0000001-e000-4000-b000-000000000012', name: { en: 'signature_price', vi: 'Giá Menu Signature', fr: 'Prix Menu Signature' }, price: 4200000 },
